...
BudVisor includes functionality such as authentication, document upload/processing, and optional agent tools that can execute commands within a constrained workspace. If you deploy this on a network, treat it as an admin-grade application:
